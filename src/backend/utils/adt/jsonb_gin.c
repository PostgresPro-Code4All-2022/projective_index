...
static bool jsonpath_match(JsonPathItem *index, List *queryl, ListCell *querylc, bool lax);
					...
					bool lax)
{
	...
	return jsonpath_match(&idxnext, queryl, querylc, lax);
}
		...
		case jpiAny:
			{
				...
				else
				{
					...
					return jsonpath_match(index, queryl, querylc, lax);
				}
			}
